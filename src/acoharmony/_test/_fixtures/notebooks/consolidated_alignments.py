...
def _(newly_added_stats):
    ...
    # Extract data
    _total = newly_added_stats['total']
    _source_breakdown = newly_added_stats['source_breakdown']
    # Calculate top sources
    _top_3_sources = _source_breakdown.head(3)
    _top_1 = _top_3_sources[0, 'newly_added_source_2025_to_2026']
    _top_1_count = _top_3_sources[0, 'count']

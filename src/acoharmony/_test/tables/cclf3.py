...
from acoharmony._tables.cclf3 import Cclf3
...
class TestCclf3:
    ...
    @pytest.mark.unit
    def test_cclf3_schema_fields(self) -> None:
        """Cclf3 has expected schema fields."""
        import dataclasses as dc

        fields = dc.fields(Cclf3)
    ...
    @pytest.mark.unit
    def test_cclf3_data_types(self) -> None:
        """Cclf3 field types match expectations."""
        import dataclasses as dc
        ...
        "clm_prcdr_cd": "str | None",
        "clm_prcdr_prfrm_dt": "date | None",

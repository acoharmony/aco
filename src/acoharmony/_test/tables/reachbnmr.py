...
"""Unit tests for reach_bnmr module."""
...
from acoharmony._tables.reach_bnmr import ReachBnmr
...
class TestReachBnmr:
    ...
    @pytest.mark.unit
    def test_reachbnmr_schema_fields(self) -> None:
        """ReachBnmr has expected schema fields."""
        import dataclasses as dc

        fields = dc.fields(ReachBnmr)
        field_names = [f.name for f in fields]
        expected = ['sheet_type']
        assert field_names == expected

    @pytest.mark.unit
    def test_reachbnmr_data_types(self) -> None:
        """ReachBnmr field types match expectations."""
        import dataclasses as dc

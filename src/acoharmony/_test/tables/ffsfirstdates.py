...
"""Unit tests for ffs_first_dates module."""
...
from acoharmony._tables.ffs_first_dates import FfsFirstDates
...
class TestFfsFirstDates:
    """Tests for FfsFirstDates."""

    # TODO: Implement tests for this class

    @pytest.mark.unit
    def test_ffsfirstdates_schema_fields(self) -> None:
        """FfsFirstDates has expected schema fields."""
        import dataclasses as dc

        fields = dc.fields(FfsFirstDates)
        field_names = [f.name for f in fields]
        expected = ['bene_mbi', 'ffs_first_date', 'claim_count', 'extracted_at']
        assert field_names == expected

    @pytest.mark.unit
    def test_ffsfirstdates_data_types(self) -> None:
        """FfsFirstDates field types match expectations."""
        import dataclasses as dc

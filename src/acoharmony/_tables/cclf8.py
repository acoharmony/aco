...
class Cclf8:
    ...
    bene_hic_num: str | None = Field(
        ...
        json_schema_extra={"start_pos": 12, "end_pos": 22, "length": 11},
    )
    bene_fips_state_cd: str | None = Field(
        default=None,
        description="Beneficiary FIPS State Code",
        json_schema_extra={"start_pos": 23, "end_pos": 24, "length": 2},
    )
    bene_fips_cnty_cd: str | None = Field(
        default=None,
        description="Beneficiary FIPS County Code",
        json_schema_extra={"start_pos": 25, "end_pos": 27, "length": 3},
    )
    bene_zip_cd: str | None = Field(
        default=None,
        description="Beneficiary ZIP Code",
        json_schema_extra={"start_pos": 28, "end_pos": 32, "length": 5},
    )
    bene_dob: date | None = Field(
        default=None,
        description="Beneficiary Date of Birth",
        json_schema_extra={"start_pos": 33, "end_pos": 42, "length": 10},
    )
    bene_sex_cd: str | None = Field(
        default=None,
        description="Beneficiary Sex Code (1=Male, 2=Female, 0=Unknown)",
        json_schema_extra={"start_pos": 43, "end_pos": 43, "length": 1},
    )
    bene_race_cd: str | None = Field(
        default=None,
        description="Beneficiary Race Code",
        json_schema_extra={"start_pos": 44, "end_pos": 44, "length": 1},
    )
    bene_age: str | None = Field(
        default=None,
        description="Beneficiary Age",
        json_schema_extra={"start_pos": 45, "end_pos": 47, "length": 3},
    )
    bene_mdcr_stus_cd: str | None = Field(
        default=None,
        description="Medicare Status Code",
        json_schema_extra={"start_pos": 48, "end_pos": 49, "length": 2},
    )
    bene_dual_stus_cd: str | None = Field(
        default=None,
        description="Dual Status Code (Medicare/Medicaid)",
        json_schema_extra={"start_pos": 50, "end_pos": 51, "length": 2},
    )
    bene_death_dt: date | None = Field(
        default=None,
        description="Beneficiary Date of Death",
        json_schema_extra={"start_pos": 52, "end_pos": 61, "length": 10},
    )
    bene_rng_bgn_dt: date | None = Field(
        default=None,
        description="Date beneficiary enrolled in Hospice",
        json_schema_extra={"start_pos": 62, "end_pos": 71, "length": 10},
    )
    bene_rng_end_dt: date | None = Field(
        default=None,
        description="Date beneficiary ended Hospice",
        json_schema_extra={"start_pos": 72, "end_pos": 81, "length": 10},
    )
    bene_fst_name: str | None = Field(
        default=None,
        description="Beneficiary First Name",
        json_schema_extra={"start_pos": 82, "end_pos": 111, "length": 30},
    )
    bene_mdl_name: str | None = Field(
        default=None,
        description="Beneficiary Middle Name",
        json_schema_extra={"start_pos": 112, "end_pos": 126, "length": 15},
    )
    bene_lst_name: str | None = Field(
        default=None,
        description="Beneficiary Last Name",
        json_schema_extra={"start_pos": 127, "end_pos": 166, "length": 40},
    )
    bene_orgnl_entlmt_rsn_cd: str | None = Field(
        default=None,
        description="Beneficiary Original Entitlement Reason Code",
        json_schema_extra={"start_pos": 167, "end_pos": 167, "length": 1},
    )
    bene_entlmt_buyin_ind: str | None = Field(
        default=None,
        description="Beneficiary Entitlement Buy-in Indicator",
        json_schema_extra={"start_pos": 168, "end_pos": 168, "length": 1},
    )
    bene_part_a_enrlmt_bgn_dt: date | None = Field(
        default=None,
        description="Part A Enrollment Begin Date",
        json_schema_extra={"start_pos": 169, "end_pos": 178, "length": 10},
    )
    bene_part_b_enrlmt_bgn_dt: date | None = Field(
        default=None,
        description="Part B Enrollment Begin Date",
        json_schema_extra={"start_pos": 179, "end_pos": 188, "length": 10},
    )
    bene_line_1_adr: str | None = Field(
        default=None,
        description="Beneficiary Derived Mailing Line One Address",
        json_schema_extra={"start_pos": 189, "end_pos": 233, "length": 45},
    )
    bene_line_2_adr: str | None = Field(
        default=None,
        description="Beneficiary Derived Mailing Line Two Address",
        json_schema_extra={"start_pos": 234, "end_pos": 278, "length": 45},
    )
    bene_line_3_adr: str | None = Field(
        default=None,
        description="Beneficiary Derived Mailing Line Three Address",
        json_schema_extra={"start_pos": 279, "end_pos": 318, "length": 40},
    )
    bene_line_4_adr: str | None = Field(
        default=None,
        description="Beneficiary Derived Mailing Line Four Address",
        json_schema_extra={"start_pos": 319, "end_pos": 358, "length": 40},
    )
    bene_line_5_adr: str | None = Field(
        default=None,
        description="Beneficiary Derived Mailing Line Five Address",
        json_schema_extra={"start_pos": 359, "end_pos": 398, "length": 40},
    )
    bene_line_6_adr: str | None = Field(
        default=None,
        description="Beneficiary Derived Mailing Line Six Address",
        json_schema_extra={"start_pos": 399, "end_pos": 438, "length": 40},
    )
    bene_city: str | None = Field(
        alias="geo_zip_plc_name",
        default=None,
        description="Beneficiary City",
        json_schema_extra={"start_pos": 439, "end_pos": 538, "length": 100},
    )
    bene_state: str | None = Field(
        alias="geo_usps_state_cd",
        default=None,
    ...
    bene_zip_ext: str | None = Field(
        alias="geo_zip4_cd",
        default=None,
        description="Beneficiary Zip Code Extension",

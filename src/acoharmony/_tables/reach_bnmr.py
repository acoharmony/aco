...
@with_sheets(
    ...
    matrix_fields=[
        ...
        },
        {
            ...
            "field_name": "aco_id",
            "data_type": "string",
            "search_label": ["Organization ID", "Entity ID"],
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "aco_type",
            "data_type": "string",
            "search_label": ["Organization Type", "Entity Type"],
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "risk_arrangement",
            "data_type": "string",
            "search_label": "Risk Arrangement",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "payment_mechanism",
            "data_type": "string",
            "search_label": "Payment Mechanism",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
        ...
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "shared_savings_rate",
            "data_type": "decimal",
        ...
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "advanced_payment_option",
            "data_type": "string",
            "search_label": "Advanced Payment Option",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "stop_loss_elected",
            "data_type": "string",
            "search_label": "Stop-Loss Elected",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "stop_loss_type",
            "data_type": "string",
            "search_label": "Stop-Loss Type",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "quality_withhold",
            "data_type": "decimal",
        ...
        },
        {
            ...
            "data_type": "decimal",
            "search_label": "Quality Score",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "voluntary_aligned_benchmark",
            "data_type": "string",
            "search_label": "Voluntary Aligned Benchmark",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "blend_percentage",
            "data_type": "decimal",
            "search_label": "Blend Percentage",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "blend_ceiling",
            "data_type": "decimal",
            "search_label": "Ceiling",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "blend_floor",
            "data_type": "decimal",
            "search_label": "Floor",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "ad_retrospective_trend",
            "data_type": "decimal",
            "search_label": "A&D Retrospective Trend",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "esrd_retrospective_trend",
            "data_type": "decimal",
            "search_label": "ESRD Retrospective Trend",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "ad_completion_factor",
            "data_type": "decimal",
            "search_label": "A&D Completion Factor",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "esrd_completion_factor",
            "data_type": "decimal",
            "search_label": "ESRD Completion Factor",
        },
        {
            "matrix": [0, 0, 1],
            "search_sheet_name": "REPORT_PARAMETERS",
            "field_name": "stop_loss_payout_neutrality_factor",
            "data_type": "decimal",
            "search_label": "Stop-Loss Payout Neutrality",
        },
    ],
)
@with_four_icli(
...
@with_acoms(
    category="Reports",
    file_type_code=115,
    file_pattern="P.A*.ACO.BNMRK.D*.T*.zip",
    extract_zip=True,

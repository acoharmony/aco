...
class BlqqrUamcc:
    ...
    first_visit_date: date | None = Field(description="First qualifying visit date")
    hospice_date: date | None = Field(default=None, description="Hospice enrollment date")
    ...
    unplanned_adm_date: date | None = Field(default=None, description="Unplanned admission date (PY2025+)")

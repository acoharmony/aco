...
from .datamodels import ModelName, ProcFilteringFilename, DxCCMappingFilename
from .model_edits import EditRule
...
def resolve_data_file(file_path: str) -> str:
    ...
    try:
        with importlib.resources.path('acoharmony._depends.hccinfhir.data', file_path) as pkg_path:
            if pkg_path.exists():
                return str(pkg_path)
    ...
    raise FileNotFoundError(
        ...
        f"  - Package data: acoharmony._depends.hccinfhir.data"
    )
